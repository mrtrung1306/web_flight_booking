...
namespace DemoMayBayCN.ApiControllers
{
    ...
    public class CheckOutController : ControllerBase
    {
        ...
        public CheckOutController(FlightsService flightsService,CheckOutService checkOutService, IMemoryCache memoryCache, IWebHostEnvironment hostEnvironment)
        {
        ...
        //    email.From.Add(MailboxAddress.Parse("mr.trung1306@gmail.com"));
        //    email.To.Add(MailboxAddress.Parse("mr.trung1307@gmail.com"));
        //    email.Subject = "Test Email Subject";
        //    email.Body = new TextPart(TextFormat.Html) { Text = body};
        //    using var smtp = new SmtpClient();
        //    smtp.Connect("smtp.gmail.com", 587, SecureSocketOptions.StartTls);
        //    smtp.Authenticate("mr.trung1306@gmail.com", "kxkplyfsmdlzydqv");
        //    smtp.Send(email);
